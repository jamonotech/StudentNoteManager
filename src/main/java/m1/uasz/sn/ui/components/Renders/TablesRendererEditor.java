...
public class TablesRendererEditor extends AbstractCellEditor implements TableCellRenderer, TableCellEditor {
    ...
    public TablesRendererEditor(String callingComponent, ActionHandler actionHandler) {
        ...
        viewIcon = createIconLabel("/img/icons/8664880_eye_view_icon.png", "Voir");
        editIcon = createIconLabel("/img/icons/8666683_edit_2_icon.png", "Modifier");
        ...
        viewIcon.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                if (table != null) {
                    ...
                    actionHandler.onView(id, callingComponent);
                }
            }
        });
        ...
        editIcon.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                if (table != null) {
                    ...
                    if (!isAuthorized()) {
                        JOptionPane.showMessageDialog(null, "Vous n'êtes pas autorisé à modifier cet élément.", "Accès refusé", JOptionPane.WARNING_MESSAGE);
                        return;
                    }

                    Object id = table.getValueAt(row, 0);
                    actionHandler.onEdit(id, callingComponent);
                }
            }
        });
