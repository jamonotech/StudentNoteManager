...
public class DetailsUsersPanel extends RoundedSideBar {
    ...
    public DetailsUsersPanel(MainFrame mainFrame, Utilisateur utilisateur) {
        ...
        JLabel titreComposantLabel = new JLabel("🛠️ DETAILS UTILISATEUR");
